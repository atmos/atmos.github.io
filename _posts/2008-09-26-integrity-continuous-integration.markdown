...
wordpress_url: http://atmos.org/?p=9
---
...
We're just running bin/integrity like the README says under <a href="http://www.gnu.org/software/screen/">GNU Screen</a>.  It hasn't crashed and doesn't seem to be leaking.
<h2>Private Repo Access</h2>
We're using <a href="http://www.gentoo.org/proj/en/keychain/">keychain</a> and github deploy keys to access our source code from crons and the ci process.
...
I'd really like to see some async build process for Integrity, or perhaps some <a href="http://devver.net/">devver</a> integration.  It's a pretty solid product and it keeps improving.
